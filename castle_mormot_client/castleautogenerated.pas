...
initialization
  ApplicationProperties.ApplicationName := 'castle_mormot_client';
  ApplicationProperties.Caption := 'Client - Collaborative editing using Castle Game Engine and mORMot2';
